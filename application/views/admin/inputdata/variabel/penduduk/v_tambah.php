<div class="right_col" role="main">
  <div class="">
    ...
    <div class="clearfix"></div>
      <div class="x_panel">
        <form action="<?php echo base_url();?>c_variabel/insert_var_penduduk" method="post">
        <div class="x_title">
          <h2>Tambah <small>Variabel</small></h2>
          <div class="form-group pull-right">
                  <button type="submit" class="btn btn-primary">Simpan</button>
                  <a class="btn btn-danger" href="<?php echo base_url('c_variabel/VariabelPenduduk') ?>">Batal</a>
              </div>
          <div class="clearfix"></div>
        </div>
        <!--ROW 1-->
        ...
        <div class="x_content">
          <div class="row">
            ...
            <div class="col-md-6 col-xs-12 form-horizontal">
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Sub Variabel</label>
              </div>
              ...
              <table class="table table-bordered" id="variabel">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="number" class="form-control 0" name="skor[]" required></td>
                  </tr>
                </tbody>                
              </table>
