        ...
        <div class="x_content">
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
              <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Nilai Tiap Kriteria</a>
              </li>
              ...
              <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th><?php echo $no++ ?> <input type="hidden" value="<?php echo $k['id'] ?>" name="id[]" class="form-control" readonly/></th>
                          <td><input type="text" value="<?php echo $k['nama'] ?>" name="nama[]" class="form-control" readonly/></td>
                          <td><input type="text" value="<?php echo $k['min'] ?>" name="min[]" class="form-control col-md-3" readonly/></td>
                          <td align="center">-</td>
                          <td><input type="text" value="<?php echo $k['max'] ?>" name="max[]" class="form-control col-md-3" readonly/></td>
                        </tr>
                      <?php } ?>
                      <div class="form-group pull-right">
                        <!-- <button type="submit" class="btn btn-primary">Update</button> -->
