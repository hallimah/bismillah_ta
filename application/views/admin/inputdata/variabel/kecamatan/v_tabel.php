                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <!-- <div class="form-group pull-right">
                     <a class="btn btn-primary" href="<php echo base_url('c_variabel/tambah_var_kecamatan/') ?>">Tambah</a>
                    </div> -->
                    ...
                    <table class="table table-hover" id="datatable">
                      ...
                      foreach ($c_variabel as $k) { ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-info btn-xs" title="Edit Data" href="<?php echo base_url('c_variabel/edit_variabel_kecamatan/'.$k->variabel_id) ?>"><i class="fa fa-pencil"></i></a>
