...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url('c_rumusfuzzy/view2/') ?>">
                    <i class="glyphicon glyphicon-plus"></i></a>
                    <a class="btn btn-primary" href="<?php echo base_url('c_rumusfuzzy/nilai_fuzzy_inferensi2/') ?>">
