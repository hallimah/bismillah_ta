...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      ...
      <div class="btn-group">
      <!-- <div class="btn-group">
        <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button"> Wilayah <span class="caret"></span> </button>
        <ul class="dropdown-menu">
          <li><a href="<php echo base_url().'c_report/dataklasifikasiKecamatan'; ?>">Kecamatan</a></li>
          <li><a href="<php echo base_url().'c_report/dataklasifikasiKelurahan'; ?>">Kelurahan</a></li>
        </ul>
      </div> -->
